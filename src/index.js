...
var Accordion = React.createClass({
  ...
  toggle() {
    ...
    this.tweenState('height', {
      ...
      endValue: this.state.height === 0.0000000001 ? this.state.content_height : 0.0000000001
    });
  },
  ...
  _getContentHeight() {
    if (this.refs.AccordionContent) {
      this.refs.AccordionContent.measure((ox, oy, width, height, px, py) => {
        ...
        this.setState({
          height: this.props.expanded ? height : 0.0000000001,
